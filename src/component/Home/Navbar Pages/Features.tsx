const Features = () => {        
  return (
      <section className="py-12 bg-[#f6f5f3] sm:py-16 lg:py-20">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
              <div className="text-center">
                  <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-6xl font-[NippoVariable]">Empower Your Testing Journey</h2>
                  <p className="leading-7 text-lg text-gray-600 sm:mt-1 font-semibold">Your one-stop destination for all things related to manual testing.</p>
              </div>
              ...
              <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                  <div className="md:p-8 lg:p-14">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Test Case Management</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Efficiently create, organize, and manage test cases to ensure comprehensive coverage.</p>
                  </div>
                  ...
                  <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Bug Tracking</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Track and manage bugs effectively with detailed reports and prioritization.</p>
                  </div>
                  ...
                  <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Test Execution</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Execute test cases manually and record results with ease.</p>
                  </div>
                  ...
                  <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Test Planning</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Plan your testing activities with detailed strategies and timelines.</p>
                  </div>
                  ...
                  <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Test Automation</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Explore tools and frameworks to automate repetitive testing tasks.</p>
                  </div>
                  ...
                  <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                      ...
                      <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Reporting & Analytics</h3>
                      <p className="mt-5 text-base text-gray-600 font-pj">Generate detailed reports and gain insights to improve testing processes.</p>
                  </div>
              </div>
          </div>
      </section>
