...
function Features() {
  ...
  return (
    <div className="bg-[#f6f5f3] flex items-center justify-center w-fit">
    <div className=" h-[31vw] bg-[#216944] rounded-full">
        <div className="flex space-x-8 p-18">
      {/* Card 1 */}
      <div className="border-5 border-gray-300  border-dashed rounded-lg p-10 w-1/2">
